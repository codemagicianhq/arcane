...
<!-- arcane:start -->
<details>
<summary><b>📜 The full spell catalogue (39)</b></summary>
...
**Build** — `implement` · `test` · `full-cycle` · `bug` · `bump` · `dotnet-expert` · `security-review` · `ship` · `enchant` · `generate-bot-icons` · `make-discoverable` · `scry` · `eas-store-deploy`
**Docs** — `adopt-docs`
