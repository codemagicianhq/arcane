...
- Use it after any session where assistance felt notably effective or notably off — the record feeds `spell-elevate`.
...
5. Confirm what was appended and where, then point the user to [`spell-elevate`](spell-elevate.prompt.md) if the feedback suggests a spell or PRD is ready to be lifted to the next quality tier.
