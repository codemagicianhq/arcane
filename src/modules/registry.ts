...
const COMPONENTS: RegistryComponent[] = [
  ...
  // here and only here -- every spell file stays flat on disk; the one
  // sanctioned relocation is ARC-045's canonical move (CS-03).
  //
  // Each component carries, per spell, the canonical source and ALL THREE
  // generated client shims (ARC-045 / CS-03): the client-neutral source
  // (.arcane/spells/*.md, always listed first), the Copilot prompt shim
  // (.github/prompts/*.prompt.md), the Claude Code command stub
  ...
  // structurally impossible for a spell's source and its shims to drift
  // apart across profiles.
  {
    ...
    files: [
      ...
      ".arcane/spells/spell-arcane-version.md",
  ...
  },
  {
    ...
    files: [
      ...
      ".arcane/spells/spell-product-review.md",
  ...
  },
  {
    ...
    files: [
      ...
      ".arcane/spells/spell-security-review.md",
      ...
      ".arcane/spells/spell-compliance.md",
  ...
  },
  {
    ...
    files: [
      ...
      ".arcane/spells/spell-manifest.md",
  ...
  },
  {
    ...
    files: [
      ".arcane/spells/spell-present-arcane.md",
